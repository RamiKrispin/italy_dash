...
The input data for this dashboard are the [covis19italy](https://github.com/RamiKrispin/covis19italy) and [coronavirus](https://github.com/RamiKrispin/coronavirus) R packages (dev version). The data and dashboard are refreshed on a daily bases. 
